  ...
  categories: [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          name: 'Brands',
          items: [
            { name: 'Alkaram', href: 'Category/Alkaram' },
            { name: 'Khaadi', href: 'Category/Khaadi' },
            { name: 'J.', href: 'Category/J.' },
            { name: 'Nishaat', href: 'Category/Nishaat' },
            { name: 'Gul Ahmed', href: 'Category/Gul' },
          ],
        },
      ],
    },
    ...
    <div className="bg-white">
              ...
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                ...
                <div className="border-t border-gray-200 px-4 py-6">
                  <a href="#" className="-m-2 flex items-center p-2">
                    ...
                    />
                    <span className="ml-3 block text-base font-medium text-gray-900">PKR</span>
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-indigo-600 px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
          Get free delivery on orders over 3500 Rs
        </p>
